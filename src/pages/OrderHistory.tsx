...
export const OrderHistory = () => {
  ...
  const handleReturnOrder = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setOrders(orders.map(o => o.id === returningOrder.id ? { ...o, status: 'return_requested' as const } : o));
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs rounded-full border transition-all ${returnReason === option
