              ...
              return (
                <div key={step.status} className="flex flex-col items-center gap-3 relative z-10 flex-1">
                  <div className="relative flex justify-center items-center">
                    <div
                      className={`relative w-10 h-10 rounded-full flex items-center justify-center transition-all duration-500 ${mounted ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-2 scale-95'
                        } ${isPast
                  ...
                  <span className={`text-[11px] font-bold tracking-wider uppercase text-center transition-all duration-500 ${mounted ? 'opacity-100' : 'opacity-0'
